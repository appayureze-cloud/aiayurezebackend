    ...
    def send_journey_completion_email(
        ...
        try:
            smtp_result = self._send_smtp_email(
                ...
                subject=f"🌿 Your Wellness Journey Report - {rating}⭐",
...
📎 Attached is your comprehensive journey report.
    ...
    def send_admin_journey_report(
        ...
        try:
            smtp_result = self._send_smtp_email(
                ...
                None, message_id, filename,
                subject=f"🔐 Admin Report: Journey {journey_id[:8]}... Completed",
...
📎 Attached: Comprehensive admin report with full journey analytics.
